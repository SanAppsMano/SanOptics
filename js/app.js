...
// Salva dados da ótica
configForm.addEventListener('submit', e => {
  e.preventDefault();
  const name = document.getElementById('optic-name').value;
  const email = document.getElementById('admin-email').value;
  localStorage.setItem('opticName', name);
...
loginForm.addEventListener('submit', e => {
  e.preventDefault();
  const name = document.getElementById('optic-name-login').value;
